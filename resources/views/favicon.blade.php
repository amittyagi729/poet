...
<link rel="apple-touch-icon" sizes="192x192"  href="{{asset('assets/images/favicon/android-icon-192x192.png')}}">
...
<meta name="msapplication-square70x70logo" content="{{asset('assets/images/favicon/ms-icon-70x70.png')}}" />
<meta name="msapplication-square144x144logo" content="{{asset('assets/images/favicon/ms-icon-144x144.png')}}" />
<meta name="msapplication-wide150x150logo" content="{{asset('assets/images/favicon/ms-icon-150x150.png')}}" />
<meta name="msapplication-square310x310logo" content="{{asset('assets/images/favicon/ms-icon-310x310.png')}}" />
